...
class Maze:
    ...
    def show_hide_solution_path(self, stdscr, path, maze_color, show) -> None:
    ...
    def dfs(self, stdscr, y, x, maze_color) -> None:
    ...
    def prime(self, stdscr, y, x, maze_color):
    ...
    def make_it_imperfect(self, stdscr, maze_color):
